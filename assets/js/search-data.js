...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/Compilation-WHILE-NASM/";
            },},{id: "projects-game-ai",
          title: 'Game AI',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/AI-lines-of-action/";
            },},{id: "projects-gns3-library",
          title: 'GNS3 Library',
          description: "Creation of a fluent Scala API to create and manipulate network structures in GNS3.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/GNS3-API-Scala/";
            },},{id: "projects-first-poster",
          title: 'First Poster',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/posterECMFA2019/";
            },},{id: "projects-roblang",
          title: 'RobLANG',
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/RobLANG-an-action-language-for-robotics/";
